...
?>
    ...
    <!-- Bootstrap -->
    <link href="src/js/vendors/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Font Awesome -->
    <link href="src/js/vendors/font-awesome/css/font-awesome.min.css" rel="stylesheet">
    <!-- NProgress -->
    ...
    <!-- JQVMap -->
    <link href="src/js/vendors/jqvmap/dist/jqvmap.min.css" rel="stylesheet"/>
    <!-- bootstrap-daterangepicker -->
    <link href="src/js/vendors/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">

    <!-- Custom Theme Style -->
    <link href="src/js/build/css/custom.min.css" rel="stylesheet">


	<script type="text/javascript" src="src/js/require.js" data-main="src/js/main.js"></script>

</head>
    <body onload="onBodyLoaded()" class="nav-md">
    ...
    //require('datetimepicker');
		...
		if ($db->count > 0){
		    ...
		    foreach ($users as $user) { $date = $status =='pending' ? $user['invited_on'] : $user['active_on'];
				...
				$('.leads_stats').append(\"<a href='#' style='margin-left:20px; font-size;' class='export_$count btn btn-success'>Export Table data into Excel</a> <b>{$user['active']} $status on $date</b>\"+
